...
MANUAL_DATE_OVERRIDES = {
    ...
    "wsQoemJXWMg": "2023-01-05",  # 仕事を辞めると言ってきたリスクを嫌う友人【コラム動画】
    # 革命前夜シリーズ：メンバー再アップ版(2026-07-13)で登録されたが実配信は2023年。
    # 元の公開版が非公開化され動画タブ走査で拾えないため手動固定。
    "veGpUi-vNCE": "2023-10-06",  # 革命前夜（元公開版 rf5P9rquNNg=2023-10-06）
    "i2m9G9QvsWw": "2023-10-11",  # 続・革命前夜（元公開版 s8KVHNoAdQY=2023-10-11）
}
